...
namespace GoodSamaritan.Controllers
{
    public class SocialWorkAttendancesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SocialWorkAttendanceId,Value")] SocialWorkAttendance socialWorkAttendance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SocialWorkAttendanceId,Value")] SocialWorkAttendance socialWorkAttendance)
        {
            if (ModelState.IsValid)
            {
