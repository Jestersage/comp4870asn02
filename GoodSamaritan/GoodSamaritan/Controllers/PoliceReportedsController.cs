...
namespace GoodSamaritan.Controllers
{
    public class PoliceReportedsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PoliceReportedId,Value")] PoliceReported policeReported)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PoliceReportedId,Value")] PoliceReported policeReported)
        {
            if (ModelState.IsValid)
            {
