...
namespace GoodSamaritan.Controllers
{
    public class VictimServicesAttendancesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VictimServicesAttendanceId,Value")] VictimServicesAttendance victimServicesAttendance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VictimServicesAttendanceId,Value")] VictimServicesAttendance victimServicesAttendance)
        {
            if (ModelState.IsValid)
            {
